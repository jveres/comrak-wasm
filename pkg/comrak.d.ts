...
export interface InitOutput {
    ...
    readonly getFrontmatter: (a: number, b: number, c: any) => [number, number];
    readonly headingadapter_new: (a: any, b: any) => number;
    readonly healMarkdown: (a: number, b: number) => [number, number];
    readonly mdToAnsi: (a: number, b: number, c: any, d: any) => [number, number];
    readonly mdToCommonmark: (a: number, b: number, c: any) => [number, number];
    readonly mdToHtml: (a: number, b: number, c: any) => [number, number];
    readonly mdToHtmlWithCodefenceRenderers: (a: number, b: number, c: any, d: any, e: number, f: number) => [number, number];
    readonly mdToHtmlWithPlugins: (a: number, b: number, c: any, d: number, e: number) => [number, number];
    readonly mdToHtmlWithRewriters: (a: number, b: number, c: any, d: any, e: any) => [number, number];
    readonly mdToText: (a: number, b: number, c: any, d: number, e: number, f: number, g: number) => [number, number];
    readonly mdToXml: (a: number, b: number, c: any) => [number, number];
    readonly mdToXmlWithPlugins: (a: number, b: number, c: any, d: number, e: number) => [number, number];
