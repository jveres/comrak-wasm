...
export class CodefenceRenderer {
    static __wrap(ptr) {
        const obj = Object.create(CodefenceRenderer.prototype);
        obj.__wbg_ptr = ptr;
        CodefenceRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    static __unwrap(jsValue) {
        if (!(jsValue instanceof CodefenceRenderer)) {
            return 0;
        }
     ...
     * @returns {CodefenceRenderer}
     */
    clone() {
        const ret = wasm.codefencerenderer_clone(this.__wbg_ptr);
        return CodefenceRenderer.__wrap(ret);
    }
    /**
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_codefencerenderer_unwrap: function(arg0) {
            const ret = CodefenceRenderer.__unwrap(arg0);
            return ret;
        },
